...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">INFO@HOTELPARADISE.COM</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801944275646</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">HOTEL <span>PARADISE</span></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Reservation</a></li>
							<li class="menu__item"><a href="new\review_login.php">Reviews</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>HOTEL  <span>PARADISE</span></h4>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">HOTEL PARADISE</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<div class="advantages" id="about">
	<div class="container">
		<div class="advantages-main">
				...
				<p style="color:white">Providing guests unique and enchanting views from their rooms with its exceptional amenities, makes Star Hotel one of bests in its kind.Try our food menu, awesome services and friendly staff while you are here.</p>
				<br>
			 ...
			 <div class="col-md-6 advantage-grid left-w3ls wow bounceInLeft" data-wow-delay="0.3s">
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p>At certain times, however, duties and necessities, or the necessities of life, will often occur as well as pleasures.</p>
...
<!-- //gallery -->
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet">	
								...
								<a href="new\index_log.php" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
	 ...
	 <!--// rooms & rates -->
			...
			<div class="copy">
		        <p>© 2017 HOTEL PARADISE . All Rights Reserved | Design by <a href="index.php">HOTEL PARADISE</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
